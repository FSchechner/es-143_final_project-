...
parser.add_argument('--format', default='avi', choices=['gif', 'avi', 'mov'])
...
def create_video(images, output_file, fps=30, size=None, fourcc_name='XVID'):
    """
...
def main():
    ...
    if args.format == 'avi':
        ...
        create_video(img_stack, output_file, fourcc_name='XVID')

    if args.format == 'mov':
        output_file = f'{args.datadir}/output.mov'
        create_video(img_stack, output_file, fourcc_name='mp4v')
