...
parser.add_argument('--max_image_num', type=int, default=25)
...
def main():
    ...
    if len(test_data) == 0:
        print(f'No objects found in {args.test_dir} matching *{args.test_ext}. Please check your test_dir and file naming.')
        return
