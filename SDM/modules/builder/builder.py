...
class builder():
    def __init__(self, args, device):
        ...
        if 'normal' in args.target:
            ...
            self._set_no_grad(self.net_nml)
        if 'brdf' in args.target:
            ...
            self._set_no_grad(self.net_brdf)
        print('')
    ...
    def load_models(self, model, dirpath):
        ...
        model = loadmodel(model, pytmodel, strict=False, map_location=self.device)
        return model
